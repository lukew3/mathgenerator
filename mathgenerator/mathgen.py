...
def multiplicationFunc(maxProduct = 99, maxMultiplicant = 99):
    a = random.randint(0, maxMultiplicant)
    b = random.randint(0, min(maxProduct, maxMultiplicant))
    c = a*b
    problem = str(a) + " x " + str(b) + " = "
    solution = str(c)
    return problem, solution

def divisionFunc(maxQout = 99, maxDivident = 99):
    a = random.randint(0, maxDivid)
    b = random.randint(0, min(maxQoutient, maxDivident))
    c = a/b
    problem = str(a) + " / " + str(b) + " = "
    solution = str(c)
    return problem, solution    
...
multiplication = Generator("Multiplition", 4, "a x b = ", "c", multiplicationFunc)
