...
hypotenuse = Generator("Hypotenuse of a Right-angled Triangle", 68, "Hypotenuse of a right angled triangle when base = b and height = h is: ", "hypotenuse", hypotenuseFunc)
