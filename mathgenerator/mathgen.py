...
def sumDigits(maxNo=1000):
    n = random.randint(1, maxNo)
    rand_val = n
    while n > 9:
        n = sum(int(i) for i in str(n))

    solution = n
    problem = f'Digit sum numbers of {rand_val} ='
    return problem, solution
...
sumDigits = Generator("Digit sum numbers", 50, "Digit sum of numbers =", "sum_val", sumDigits)
