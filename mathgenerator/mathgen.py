...
def compoundInterestFunc(maxPrinciple=10000, maxRate=10, maxTime=10):
    ...
    a = p * (1 + r / 100 )**n
    problem = "Compound interest for a principle amount of " + str(p) + " dollars, " + str(r) + "% rate of interest and for a time period of " + str(n) + " year is = "
    solution = round(a,2)
    return problem, solution
...
compoundInterest = Generator("Compound Interest",61, "Compound interest for a principle amount of a dollars, b% rate of interest and for a time period of c years is = ", "d dollars", compoundInterestFunc)
